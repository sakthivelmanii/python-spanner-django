...
class DatabaseFeatures(BaseDatabaseFeatures):
    ...
    skip_tests = CI_SKIP_TESTS + (
        ...
        "admin_changelist.tests.ChangeListTests.test_list_editable_atomicity.test_list_editable_atomicity",
        "aggregation_regress.tests.AggregationTests.test_aggregate_and_annotate_duplicate_columns_unmanaged.test_aggregate_and_annotate_duplicate_columns_unmanaged",
        "auth_tests.test_views.ChangelistTests.test_view_user_password_is_readonly.test_view_user_password_is_readonly",
        "auth_tests.test_views.UUIDUserTests.test_admin_password_change.test_admin_password_change",
        "db_functions.math.test_degrees.DegreesTests.test_decimal.test_decimal",
        "db_functions.math.test_mod.ModTests.test_float.test_float",
        "empty.tests.EmptyModelTests.test_empty.test_empty",
        "expressions.test_queryset_values.ValuesExpressionsTests.test_values_expression.test_values_expression",
        "field_defaults.tests.DefaultTests.test_bulk_create_all_db_defaults.test_bulk_create_all_db_defaults",
        "field_defaults.tests.DefaultTests.test_bulk_create_all_db_defaults_one_field.test_bulk_create_all_db_defaults_one_field",
        "field_defaults.tests.DefaultTests.test_bulk_create_mixed_db_defaults.test_bulk_create_mixed_db_defaults",
        "field_defaults.tests.DefaultTests.test_bulk_create_mixed_db_defaults_function.test_bulk_create_mixed_db_defaults_function",
        "field_defaults.tests.DefaultTests.test_case_when_db_default_no_returning.test_case_when_db_default_no_returning",
        "field_defaults.tests.DefaultTests.test_db_default_function.test_db_default_function",
        "field_defaults.tests.DefaultTests.test_field_db_defaults_refresh.test_field_db_defaults_refresh",
        "field_defaults.tests.DefaultTests.test_foreign_key_db_default.test_foreign_key_db_default",
        "field_defaults.tests.DefaultTests.test_full_clean.test_full_clean",
        "field_defaults.tests.DefaultTests.test_null_db_default.test_null_db_default",
        "field_defaults.tests.DefaultTests.test_pk_db_default.test_pk_db_default",
        "model_inheritance_regress.tests.ModelInheritanceTest.test_id_field_update_on_ancestor_change.test_id_field_update_on_ancestor_change",
        "order_with_respect_to.tests.TestOrderWithRespectToOneToOnePK.test_set_order.test_set_order",
        "queries.test_q.QCheckTests.test_basic.test_basic",
        "queries.test_q.QCheckTests.test_boolean_expression.test_boolean_expression",
        "queries.test_q.QCheckTests.test_expression.test_expression",
        "queries.test_qs_combinators.QuerySetSetOperationTests.test_union_with_select_related_and_order.test_union_with_select_related_and_order",
        "schema.tests.SchemaTests.test_add_foreign_key_quoted_db_table.test_add_foreign_key_quoted_db_table",
        "schema.tests.SchemaTests.test_alter_auto_field_to_integer_field.test_alter_auto_field_to_integer_field",
        "schema.tests.SchemaTests.test_alter_field_default_dropped.test_alter_field_default_dropped",
        "schema.tests.SchemaTests.test_alter_field_fk_keeps_index.test_alter_field_fk_keeps_index",
        "schema.tests.SchemaTests.test_alter_field_fk_to_o2o.test_alter_field_fk_to_o2o",
        "schema.tests.SchemaTests.test_alter_field_o2o_keeps_unique.test_alter_field_o2o_keeps_unique",
        "schema.tests.SchemaTests.test_alter_field_o2o_to_fk.test_alter_field_o2o_to_fk",
        "schema.tests.SchemaTests.test_char_field_with_db_index_to_fk.test_char_field_with_db_index_to_fk",
        "schema.tests.SchemaTests.test_m2m_create.test_m2m_create",
        "schema.tests.SchemaTests.test_m2m_create_custom.test_m2m_create_custom",
        "schema.tests.SchemaTests.test_m2m_create_inherited.test_m2m_create_inherited",
        "schema.tests.SchemaTests.test_m2m_create_through.test_m2m_create_through",
        "schema.tests.SchemaTests.test_m2m_create_through_custom.test_m2m_create_through_custom",
        "schema.tests.SchemaTests.test_m2m_create_through_inherited.test_m2m_create_through_inherited",
        "schema.tests.SchemaTests.test_m2m_custom.test_m2m_custom",
        "schema.tests.SchemaTests.test_m2m_db_constraint.test_m2m_db_constraint",
        "schema.tests.SchemaTests.test_m2m_db_constraint_custom.test_m2m_db_constraint_custom",
        "schema.tests.SchemaTests.test_m2m_db_constraint_inherited.test_m2m_db_constraint_inherited",
        "schema.tests.SchemaTests.test_m2m_inherited.test_m2m_inherited",
        "schema.tests.SchemaTests.test_m2m_through_alter.test_m2m_through_alter",
        "schema.tests.SchemaTests.test_m2m_through_alter_custom.test_m2m_through_alter_custom",
        "schema.tests.SchemaTests.test_m2m_through_alter_inherited.test_m2m_through_alter_inherited",
        "schema.tests.SchemaTests.test_remove_field_check_does_not_remove_meta_constraints.test_remove_field_check_does_not_remove_meta_constraints",
        "schema.tests.SchemaTests.test_text_field_with_db_index_to_fk.test_text_field_with_db_index_to_fk",
        "schema.tests.SchemaTests.test_unsupported_transactional_ddl_disallowed.test_unsupported_transactional_ddl_disallowed",
        ...
        "view_tests.tests.test_defaults.DefaultsTests.test_custom_bad_request_template.test_custom_bad_request_template",
        "view_tests.tests.test_defaults.DefaultsTests.test_error_pages.test_error_pages",
    )
