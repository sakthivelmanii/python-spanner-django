...
class TestOperations(SpannerSimpleTestClass):
    ...
    def test_sql_flush(self):
        ...
        self.db_operations.connection.introspection.get_key_columns = MagicMock(return_value=[])
        # Mock cursor context manager
        self.db_operations.connection.cursor = MagicMock()
        self.db_operations.connection.cursor.return_value.__enter__.return_value = MagicMock()
